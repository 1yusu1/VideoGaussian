...
- Keeping DA3 cameras fixed while using XFeat as a match-mask support signal beats naive DA3 initialization: `da3_xfeat_mask_mcmc_cap2600_dense_depthreg_fps12_conf96` reaches PSNR `27.2528`, SSIM `0.8825`, LPIPS `0.1854` versus `da3_gs_fps12_conf96` at PSNR `26.4729`, SSIM `0.8723`, LPIPS `0.2516`.
